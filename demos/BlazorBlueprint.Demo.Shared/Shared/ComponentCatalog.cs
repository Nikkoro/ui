...
internal static class ComponentCatalog
{
    ...
    internal static IReadOnlyList<Entry> Items { get; } =
        new Entry[]
        {
            ...
            new("Exit Prompt", "/components/exit-prompt", "Holds a navigation while there is unsaved work, and asks before letting it go", "door-open", IsNew: true, Component: "BbExitPrompt"),
            ...
            new("Form Field Date Input", "/components/form-field-date-input", "Segmented date input with built-in label, helper text, and error messages", "component", IsNew: true, Component: "BbFormFieldDateInput"),
            ...
            new("Form Field Quantity Stepper", "/components/form-field-quantity-stepper", "Quantity stepper with built-in label, helper text, and error messages", "component", IsNew: true, Component: "BbFormFieldQuantityStepper"),
            ...
            new("Form Field Time Input", "/components/form-field-time-input", "Segmented time input with built-in label, helper text, and error messages", "component", IsNew: true, Component: "BbFormFieldTimeInput"),
            ...
            new("Image", "/components/image", "Image with a fallback for a source that cannot be loaded", "image", IsNew: true, Component: "BbImage"),
            ...
            new("Scroll To Top", "/components/scroll-to-top", "Floating button that returns a scrolled container to the top", "arrow-up-to-line", IsNew: true, Component: "BbScrollToTop"),
